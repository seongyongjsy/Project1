"""
practice 0928 프로젝트에 대한 장고 설정 파일.
...
# 빠른 개발을 위한 설정. 실제 서비스를 할 때 주의해서 적용해야 함.
...
SECRET_KEY = 'django-insecure-9xv063t!ei5=*5&#j4kjg9pjuz9w%!*g3)yyr4bvdzoeg&8m5&'
...
# 이 옵션이 적용되려면 하단의 USE_I18N 옵션이 True 여야함.
# LANGUAGE_CODE = 'en-us'
LANGUAGE_CODE = 'ko-kr'
...
# 데이터베이스 관련 설정을 할 떄, PK 필드를 따로 설정하지 않았다면
# 자동으로 적용시킬 자료형.
